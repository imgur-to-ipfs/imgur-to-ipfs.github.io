...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-yhfi2h");
    			add_render_callback(() => /*div_elementresize_handler*/ ctx[13].call(div));
    			add_location(div, file$1, 35, 0, 1054);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*columns, imageClass, onclickEvent*/ 19) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			img = element("img");
    			if (img.src !== (img_src_value = /*url*/ ctx[17])) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			set_style(img, "opacity", "50%");
    			attr_dev(img, "class", img_class_value = "" + (null_to_empty(/*imageClass*/ ctx[1]) + " svelte-yhfi2h"));
    			add_location(img, file$1, 39, 8, 1223);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*onclickEvent*/ ctx[0])) /*onclickEvent*/ ctx[0].apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*columns*/ 16 && img.src !== (img_src_value = /*url*/ ctx[17])) {
    				attr_dev(img, "src", img_src_value);
    			}

    			if (dirty & /*imageClass*/ 2 && img_class_value !== (img_class_value = "" + (null_to_empty(/*imageClass*/ ctx[1]) + " svelte-yhfi2h"))) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(39:8) {#each column as url}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			attr_dev(div, "class", "column svelte-yhfi2h");
    			add_location(div, file$1, 37, 4, 1162);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "svelte-yhfi2h");
    			add_location(div, file$1, 30, 0, 938);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "DOMNodeInserted", /*Draw*/ ctx[6], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function Draw() {
    		...
    		for (let i = 0; i < images.length; i++) {
    			...
    			$$invalidate(4, columns[idx] = [...columns[idx] || [], images[i].src], columns);
    		}
    	}

    	const writable_props = ["gap", "maxColumnWidth", "onclickEvent", "imageClass"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("maxColumnWidth" in $$props) $$invalidate(8, maxColumnWidth = $$props.maxColumnWidth);
    		if ("onclickEvent" in $$props) $$invalidate(0, onclickEvent = $$props.onclickEvent);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("columnCount" in $$props) $$invalidate(9, columnCount = $$props.columnCount);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*galleryWidth, maxColumnWidth*/ 260) {
    			$$invalidate(9, columnCount = parseInt(galleryWidth / maxColumnWidth) || 1);
    		}

    		if ($$self.$$.dirty & /*columnCount*/ 512) {
    			columnCount && Draw();
    		}

    		if ($$self.$$.dirty & /*columnCount, gap*/ 640) {
    ...
    const selectedImagesStore = writable(0);
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file, 188, 2, 5510);
    		},
    		m: function mount(target, anchor) {
    ...
    // (164:1) {#if parsed.access_token != undefined}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p0 = element("p");
    			p0.textContent = "0 images selected.";
    			t1 = space();
    			...
    			div2 = element("div");
    			p1 = element("p");
    			p1.textContent = "Upload to:";
    			t5 = space();
    			div0 = element("div");
    			input0 = element("input");
    			t6 = space();
    			label0 = element("label");
    			label0.textContent = "localhost:";
    			t8 = space();
    			...
    			add_location(p0, file, 164, 2, 4361);
    			attr_dev(button0, "id", "selectAllButton");
    			add_location(button0, file, 165, 2, 4410);
    			add_location(p1, file, 168, 3, 4513);
    			attr_dev(input0, "type", "radio");
    			attr_dev(input0, "id", "localhost");
    			attr_dev(input0, "name", "uploadTarget");
    			input0.value = "localhost";
    			input0.checked = true;
    			add_location(input0, file, 170, 4, 4546);
    			attr_dev(label0, "for", "localhost");
    			add_location(label0, file, 171, 4, 4633);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "id", "localhostPort");
    			input1.value = "8080";
    			add_location(input1, file, 172, 4, 4680);
    			add_location(div0, file, 169, 3, 4535);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "id", "api");
    			attr_dev(input2, "name", "uploadTarget");
    			input2.value = "api";
    			add_location(input2, file, 175, 4, 4758);
    			attr_dev(label1, "for", "api");
    			add_location(label1, file, 176, 4, 4825);
    			attr_dev(input3, "type", "text");
    			attr_dev(input3, "id", "apiUrl");
    			add_location(input3, file, 177, 4, 4867);
    			add_location(div1, file, 174, 3, 4747);
    			attr_dev(button1, "id", "uploadButton");
    			set_style(button1, "display", "none");
    			add_location(button1, file, 179, 3, 4914);
    			attr_dev(div2, "id", "uploadTool");
    			add_location(div2, file, 167, 2, 4487);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(164:1) {#if parsed.access_token != undefined}",
    		ctx
    	});
    ...
    // (183:2) <Gallery gap="10" onclickEvent={imageClicked} imageClass="imgurImage">
    function create_default_slot(ctx) {
    	let html_tag;

    	let raw_value = getImages([
    		"https://via.placeholder.com/180x200/1",
    		"https://via.placeholder.com/210x200/1",
    		"https://via.placeholder.com/250x200/1",
    		"https://via.placeholder.com/180x200/1",
    		"https://via.placeholder.com/210x200/1",
    		"https://via.placeholder.com/250x200/1",
    		"https://via.placeholder.com/180x200/1",
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(183:2) <Gallery gap=\\\"10\\\" onclickEvent={imageClicked} imageClass=\\\"imgurImage\\\">",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*parsed*/ ctx[0].access_token != undefined) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 162, 1, 4294);
    			attr_dev(main, "class", "svelte-1n265be");
    			add_location(main, file, 161, 0, 4285);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function updateCounter() {
    		...
    		selectAllButton.textContent = selectedImages.length == allImages.length
    		? "Deselect all"
    		: "Select all";
    ...
    */
    	...
    	console.log(parsed);
    	const writable_props = ["name", "selectedImages", "parsed", "imgurUrl"];
    	...
    	return [parsed, name, imageClicked, imgurUrl, toggleAll, selectedImages];
    }
